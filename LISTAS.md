...
### Agrupadas por tipo de amenaza:

| **Tipo de Amenaza** | **Listas RBL (Actualizado)** |
| :--- | :--- |
| **Combinada / Múltiples** | `zen.spamhaus.org`, `sbl-xbl.spamhaus.org`, `all.spamrats.com`, `combined.abuse.ch`, `combined.njabl.org`, `combined.rbl.msrbl.net`, `0spam.fusionzero.com`, `0spam-killlist.fusionzero.com`, `0spamtrust.fusionzero.com`, `all.dnsbl.bit.nl`, `csi.cloudmark.com`, `dnsbl.sorbs.net`, `dnsrbl.org`, `hostkarma.junkemailfilter.com`, `rbl.blockedservers.com`, `rbl-plus.mail-abuse.org`, `ubl.unsubscore.com`. |
| **Spam / Correo no deseado** | `sbl.spamhaus.org`, `css.spamhaus.org`, `bl.spamcop.net`, `dnsbl.sorbs.net`, `dnsbl-1.uceprotect.net`, `dnsbl-2.uceprotect.net`, `dnsbl-3.uceprotect.net`, `b.barracudacentral.org`, `bb.barracudacentral.org`, `bl.mailspike.net`, `backscatter.spameatingmonkey.net`, `spam.dnsbl.anonmails.de`, `bl.blocklist.de`, `access.redhawk.org`, `accredit.habeas.com`, `all.rbl.jp`, `all.s5h.net`, `blackholes.mail-abuse.org`, `blacklist.sci.kun.nl`, `blacklist.woody.ch`, `bl.deadbeef.com`, `bl.drmx.org`, `bl.emailbasura.org`, `bl.konstant.no`, `bl.mav.com.br`, `bl.nszones.com`, `bl.rbl-dns.com`, `bl.scientificspam.net`, `bl.score.senderscore.com`, `bl.shlink.org`, `bl.spamcannibal.org`, `bl.spameatingmonkey.net`, `bl.spamstinks.com`, `bl.suomispam.net`, `bl.tiopan.com`, `block.dnsbl.sorbs.net`, `bsb.empty.us`, `bsb.spamlookup.net`, `cdl.anti-spam.org.cn`, `db.wpbl.info`, `dnsbl-0.uceprotect.net`, `dnsbl.anticaptcha.net`, `dnsbl.aspnet.hu`, `dnsblchile.org`, `dnsbl.cobion.com`, `dnsbl.cyberlogic.net`, `dnsbl.inps.de`, `dnsbl.justspam.org`, `dnsbl.kempt.net`, `dnsbl.madavi.de`, `dnsbl.net.ua`, `dnsbl.rizon.net`, `dnsbl.rv-soft.info`, `dnsbl.rymsho.ru`, `dnsbl.spam-champuru.livedoor.com`, `dnsbl.tornevall.org`, `dnsbl.webequipped.com`, `dnsbl.zapbl.net`, `dnsrbl.swinog.ch`, `escalations.dnsbl.sorbs.net`, `eswlrev.dnsbl.rediris.es`, `feb.spamlab.com`, `fnrbl.fast.net`, `forbidden.icm.edu.pl`, `gl.suomispam.net`, `hil.habeas.com`, `hul.habeas.com`, `iadb.isipp.com`, `iadb2.isipp.com`, `ips.backscatterer.org`, `ispmx.pofon.foobar.hu`, `ix.dnsbl.manitu.net`, `korea.services.net`, `l1.bbfh.ext.sorbs.net`, `l2.bbfh.ext.sorbs.net`, `l3.bbfh.ext.sorbs.net`, `l4.bbfh.ext.sorbs.net`, `list.blogspambl.com`, `list.quorum.to`, `list.bbfh.org`, `mail-abuse.blacklist.jippg.org`, `mtawlrev.dnsbl.rediris.es`, `netblockbl.spamgrouper.to`, `netbl.spameatingmonkey.net`, `netscan.rbl.blockedservers.com`, `new.spam.dnsbl.sorbs.net`, `nobl.junkemailfilter.com`, `no-more-funn.moensted.dk`, `old.spam.dnsbl.sorbs.net`, `orvedb.aupads.org`, `pofon.foobar.hu`, `problems.dnsbl.sorbs.net`, `psbl.surriel.com`, `rbl.efnet.org`, `rbl.fasthosts.co.uk`, `rbl.interserver.net`, `rbl.iprange.net`, `rbl.lugh.ch`, `rbl.schulte.org`, `rbl.suresupport.com`, `rbl.talkactive.net`, `rbl.abuse.ro`, `rbl.choon.net`, `rbl.dns-servicios.com`, `rbl2.triumf.ca`, `recent.spam.dnsbl.sorbs.net`, `rep.mailspike.net`, `rsbl.aupads.org`, `sa-accredit.habeas.com`, `sa.senderbase.org`, `sbl.nszones.com`, `score.senderscore.com`, `short.rbl.jp`, `singlebl.spamgrouper.com`, `singular.ttk.pte.hu`, `sohul.habeas.com`, `spamlist.or.kr`, `spam.pedantic.org`, `spam.rbl.blockedservers.com`, `spam.rbl.msrbl.net`, `spam.spamrats.com`, `spamguard.leadmon.net`, `spamsources.fabel.dk`, `srn.surgate.net`, `st.technovision.dk`, `truncate.gbudb.net`, `unsure.nether.net`, `vote.drbl.caravan.ru`, `vote.drbldf.dsbl.ru`, `vote.drbl.gremlin.ru`, `wadb.isipp.com`, `wbl.triumf.ca`, `work.drbl.caravan.ru`, `work.drbldf.dsbl.ru`, `work.drbl.gremlin.ru`, `z.mailspike.net`. |
| **Malware / Botnet** | `xbl.spamhaus.org`, `cbl.abuseat.org`, `badnets.spameatingmonkey.net`, `drone.abuse.ch`, `ipbl.zeustracker.abuse.ch`, `spam.abuse.ch`, `virus.rbl.msrbl.net`, `web.rbl.msrbl.net`, `dyna.spamrats.com`, `noptr.spamrats.com`, `bad.psky.me`, `httpbl.abuse.ch`, `virbl.bit.nl`, `virbl.dnsbl.bit.nl`. |
| **Proxy / Tor / IPs Dinámicas** | `proxies.dnsbl.sorbs.net`, `relays.dnsbl.sorbs.net`, `relays.mail-abuse.org`, `relays.bl.kundenserver.de`, `dnsbl.proxybl.org`, `exitnodes.tor.dnsbl.sectoor.de`, `opm.tornevall.org`, `tor.dnsbl.sectoor.de`, `tor.efnet.org`, `torexit.dan.me.uk`, `dyn.nszones.com`, `dynip.rothen.com`. |
| **Phishing** | `phishing.rbl.msrbl.net`, `images.rbl.msrbl.net`. |
| **Política / Listas Blancas / Infraestructura** | `pbl.spamhaus.org`, `dul.dnsbl.sorbs.net`, `dul.pacifier.net`, `asn.routeviews.org`, `aspath.routeviews.org`, `bogons.cymru.com`, `v4.fullbogons.cymru.com`, `dnswl.inps.de`, `dsn.rfc-ignorant.org`, `free.v4bl.org`, `geobl.spameatingmonkey.net`, `ip.v4bl.org`, `ips.whitelisted.org`, `list.dnswl.org`, `netblock.pedantic.org`, `plus.bondedsender.org`, `query.bondedsender.org`, `rwl.choon.net`, `service.mailwhitelist.com`, `swl.spamhaus.org`, `trusted.nether.net`, `whitelist.sci.kun.nl`, `whitelist.surriel.com`, `wl.mailspike.net`, `wl.nszones.com`, `wl.shlink.org`. |
